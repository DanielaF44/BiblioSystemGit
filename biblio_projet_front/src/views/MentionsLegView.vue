<template>
  ...
  <p>
    ...
    Ce site web met à disposition des Clients :
  </p>
  ...
  <p>
    ...
    détenues par le site web pour la gestion de votre compte, de la gestion de
    la relation client et à des fins d’analyses et de statistiques.
  </p>
  ...
  <p>
    ...
    internet l'identité des différents intervenants dans le cadre de sa
    réalisation et de son suivi:
  </p>
  <p>
    <strong>Propriétaire</strong> : SA Bibliothèque Pontault-Combault Capital
    social de 0000€ Numéro de TVA: 00000000000 – Adresse 31000 Ville<br />

    <strong>Responsable publication</strong> : Monsieur le Rédacteur –
    redacteur@biblio.com<br />
    Le responsable publication est une personne physique ou une personne
    morale.<br />
    <strong>Webmaster</strong> : Daniela – email.web@web.com<br />
    <strong>Hébergeur</strong> : Heroku – Adresse Heroku 31000 Ville 0000000<br />
    <strong>Délégué à la protection des données</strong> : M. Le Maire –
    maire@biblio.com<br />
  </p>
  ...
  <p>
    ...
    décidée par le site web, qui s’efforcera alors de communiquer préalablement
    aux utilisateurs les dates et heures de l’intervention. Le site web est mis
    à jour régulièrement par responsable. De la même façon, les mentions légales
  ...
  <p>
    ...
    l’ensemble des activités de la société. Le site s’efforce de fournir des
  ...
  <p>
    ...
    génération mis-à-jour Le site est hébergé chez un prestataire sur le
  ...
  <p>
    Le site web et l’hébergeur ne pourront être tenus responsables en cas de
  ...
  <p>
    La Bibliothèque de Pontault-Combault est propriétaire des droits de
    ...
    logos, vidéos, icônes et sons. Toute reproduction, représentation,
    ...
    autorisation écrite préalable du responsable du site.
  </p>
  ...
  <p>
    La bibliothèque Pontault-Combault agit en tant qu’éditeur du site. est
    responsable de la qualité et de la véracité du Contenu qu’il publie.
  </p>

  <p>
    Le site web ne pourra être tenu responsable des dommages directs et
    indirects causés au matériel de l’utilisateur, lors de l’accès au site
    internet, et résultant soit de l’utilisation d’un matériel ne répondant pas
    aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou
    d’une incompatibilité.
  </p>

  <p>
    Le site web ne pourra également être tenu responsable des dommages indirects
    (tels par exemple qu’une perte de marché ou perte d’une chance) consécutifs
    à l’utilisation du site. Des espaces interactifs (possibilité de poser des
    questions dans l’espace contact) sont à la disposition des utilisateurs. Le
    site web se réserve le droit de supprimer, sans mise en demeure préalable,
    ...
    protection des données. Le cas échéant, le site se réserve également la
  ...
  <p>
    ...
    responsable du traitement des Données Personnelles est : Bibliothèque
    Pontault-Combault. Le site web est représenté par M. Avocat, son
    représentant légal
  </p>

  <p>
    En tant que responsable du traitement des données qu’il collecte, le site
    web s’engage à respecter le cadre des dispositions légales en vigueur. Il
    ...
    traitements conforme à la réalité. Chaque fois que le site traite des
    Données Personnelles, prend toutes les mesures raisonnables pour s’assurer
    de l’exactitude et de la pertinence des Données Personnelles au regard des
    finalités pour lesquelles les traite.
  </p>

  <h3>7.2 Finalité des données collectées</h3>

  <p>Le site web est susceptible de traiter tout ou partie des données :</p>
  ...
  <p>
    Le site web ne commercialise pas vos données personnelles qui sont donc
  ...
  <ul>
    ...
    <li>
      ...
      de choisir à qui le site web devra communiquer (ou non) ses données à un
      tiers qu’ils aura préalablement désigné
    </li>
  </ul>

  <p>
    Dès que le site web a connaissance du décès d’un Utilisateur et à défaut
    d’instructions de sa part, il s’engage à détruire ses données, sauf si leur
  ...
  <p>
    ...
    l’Utilisateur peut contacter par écrit à l’adresse suivante :
  </p>

  Bibliothèque Pontault-Combault – DPO, M. Le Maire <br />
  Adresse 31000 Ville.

  <p>
    Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il
    souhaiterait que le site corrige, mette à jour ou supprime, en s’identifiant
    précisément avec une copie d’une pièce d’identité (carte d’identité ou
    passeport).
  </p>

  <p>
    Les demandes de suppression de Données Personnelles seront soumises aux
    obligations qui sont imposées au site par la loi, notamment en matière de
    conservation ou d’archivage des documents. Enfin, les Utilisateurs peuvent
  ...
  <p>
    Le site web s’interdit de traiter, héberger ou transférer les Informations
    ...
    sans en informer préalablement le client. Pour autant, le site web reste
  ...
  <p>
    Le site web s’engage à prendre toutes les précautions nécessaires afin de
    préserver la sécurité des Informations et notamment qu’elles ne soient pas
    communiquées à des personnes non autorisées. Cependant, si un incident
    impactant l’intégrité ou la confidentialité des Informations du Client est
    portée à la connaissance du site, celle-ci devra dans les meilleurs délais
    informer le Client et lui communiquer les mesures de corrections prises. Par
    ailleurs le site web ne collecte aucune « données sensibles ».
  </p>

  <p>
    Les Données Personnelles de l’Utilisateur peuvent être traitées par des
    filiales de la Bibliothèque et des sous-traitants (prestataires de
  ...
  <p>
    ...
    aux données des Utilisateurs sont principalement les agents de notre service
    client.
  </p>
  ...
  <p>
    ...
    support quelconque à des tiers. Seule l'hypothèse du rachat du site et de
    ses droits permettrait la transmission des dites informations à l'éventuel
    acquéreur qui serait à son tour tenu de la même obligation de conservation
    et de modification des données vis à vis de l'utilisateur.
  </p>
  ...
  <p>
    ...
    des Données Personnelles de Santé, le site utilise des réseaux protégés par
    des dispositifs standards tels que par pare-feu, la pseudonymisation,
    l’encryption et mot de passe.
  </p>

  <p>
    Lors du traitement des Données Personnelles, le site prend toutes les
  ...
  <p>
    ...
    mis en place avec l’autorisation de . Cependant, le site n’a pas la
      ...
      meta: [
        {
          name: "description",
          content:
            "Aspects juridiques et traitement des données personnelles de la bibliothèque",
        },
      ],
    });
  },
