<template>
  ...
  <p>
    ...
    détenues par le site web pour la gestion de votre compte, de la gestion de la relation client et à
  ...
  <p>
    ...
    internet l'identité des différents intervenants dans le cadre de sa réalisation et de
    son suivi:
  </p>
  <p>
  ...
  <p>
    ...
    décidée par le site web, qui s’efforcera alors de communiquer préalablement aux utilisateurs les
    dates et heures de l’intervention. Le site web est mis à jour régulièrement par
  ...
  <p>
    Le site internet a pour objet de fournir une information concernant l’ensemble des activités
    de la société. Le site s’efforce de fournir
  ...
  <p>
    La Bibliothèque de Pontault-Combault est propriétaire des droits de propriété intellectuelle et détient les
    ...
    utilisé, est interdite, sauf autorisation écrite préalable du responsable du site. 
  </p>
  ...
  <p>
    La bibliothèque Pontault-Combault agit en tant qu’éditeur du site.
    est responsable de la qualité et de la véracité du Contenu qu’il publie.
  </p>

  <p>
  
    Le site web ne pourra être tenu responsable des dommages directs et indirects causés au
    matériel de l’utilisateur, lors de l’accès au site internet, et résultant soit de l’utilisation d’un matériel ne répondant pas aux
    spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une
    incompatibilité.
  </p>

  <p>
    Le site web ne pourra également être tenu responsable des dommages indirects (tels par
    exemple qu’une perte de marché ou perte d’une chance) consécutifs à
    l’utilisation du site. Des espaces interactifs (possibilité de poser des questions dans l’espace
    contact) sont à la disposition des utilisateurs.
    
    Le site web se réserve le droit de supprimer, sans mise en demeure préalable, tout
    ...
    protection des données. Le cas échéant, le site
  ...
  <p>
    ...
    Pontault-Combault.
    Le site web est représenté par M. Avocat, son représentant légal
  </p>

  <p>
    En tant que responsable du traitement des données qu’il collecte, le site web 
    ...
    la réalité. Chaque fois que le site 
  ...
  <p>
    Si l’Utilisateur souhaite savoir comment le site
  ...
  <p>
    ...
    obligations qui sont imposées au site
    par la loi, notamment en matière de conservation ou d’archivage des
    documents. Enfin, les Utilisateurs 
  ...
  <p>
    ...
    connaissance du site, celle-ci devra dans les meilleurs délais informer le Client et lui
  ...
  <p>
    ...
    vendue sur un support quelconque à des tiers. Seule l'hypothèse du rachat du site
  ...
  <p>
    ...
    le site prend toutes les mesures raisonnables visant à les protéger contre toute
  ...
  setup() {
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: "Aspects juridiques et traitement des données personnelles de la bibliothèque",
        },
      ],
    });
  },
